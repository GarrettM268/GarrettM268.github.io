            ...
            ruleProperty: function() {
              ...
              if (name.length > 1 && match(/^((?:\+_|\+)?)\s*:/)) {
                ...
                for (k = 0; k < name.length; k++) {
                  s = name[k];
                  name[k] = s.charAt(0) !== "@" && s.charAt(0) !== "$" ? new tree.Keyword(s) : s.charAt(0) === "@" ? new tree.Variable("@" + s.slice(2, -1), index[k] + currentIndex, fileInfo) : new tree.Property("$" + s.slice(2, -1), index[k] + currentIndex, fileInfo);
                }
                return name;
              }
              parserInput.restore();
